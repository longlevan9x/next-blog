            ...
            <div className="container mx-auto">
                <div className="flex flex-wrap justify-between">
                    <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed gravida auctor tortor, at ornare libero tincidunt ac. Integer vulputate turpis eget mauris faucibus.</p>
                    </div>
                    <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
